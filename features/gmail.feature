Feature: Gmail
  ...
  Background:
    Given there are the following users:
      ...
      | francob411test@gmail.com | francob411test |
    And Action Mailer delivers via SMTP
    
    Given there is a project called "TextMate 2"
    And "alice@ticketee.com" can view the "TextMate 2" project
    And "francob411test@gmail.com" can view the "TextMate 2" project
    And "francob411test@gmail.com" has created a ticket for this project:
      | title        | description       |
